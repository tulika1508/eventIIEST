            ...
            <Container>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div onClick={ticketPriceHandle2} className='border-2 hover:shadow-2xl px-8 my-6 py-8 flex flex-col justify-center items-center space-y-2'>
                        ...
                        <h1 className='text-5xl font-bold pt-3 text-rose-600'></h1>
                        <div className='text-gray-500 pt-3 pb-6'>
                            <p className='border-y-2 py-3 px-6'>Full access to all events</p>
                            <p className='py-3 px-6 flex items-center gap-2'><ImCross className="text-red-600"/>Complimentary food</p>
