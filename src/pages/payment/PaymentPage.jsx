      ...
      <div className='grid md:grid-cols-3 px-4 md:px-1 lg:gap-4'>
        ...
        <div className='mt-16 col-span-2 md:col-span-1'>
          ...
          <div className='bg-slate-100 rounded-md border-2 border-black mt-7 p-5 pb-12'>
            ...
            <div className='mt-5'>
              <h2 className='flex items-center gap-2'><MdOutlineCalendarMonth />18.04.2024</h2>
              <h2 className='flex items-center gap-2 mt-2'><CiLocationOn />Shibpur</h2>
            </div>
            ...
            <div className='flex flex-col items-center'>
              ...
              <Link to={`/event-details/${event._id}`}>
                <h3 className='mt-3 border-b border-black font-semibold md:text-sm text-xl lg:text-xl'>Cancel</h3>
              </Link>
            </div>
