            ...
            >
              ...
              <div className="content">
                ...
                */}
                ...
                <div>
                  <div>
                    <p className="text-xl ml-1 font-semibold tracking-wider text-slate-300">IIEST Event Management</p>
                  </div>
                  <div className="my-5"><h1 className="text-3xl lg:text-6xl font-bold text-slate-200">Our Events</h1></div>
                  <div className="my-5"><h1 className="drop-shadow-2xl text-lime-500 text-5xl lg:text-7xl font-bold">Book Your ticket now!</h1></div>
